...
async function renderPage() {
    return import(/* webpackChunkName: "vue", webpackPreload: true */ 'vue').then(async({default: Vue}) => {
        return import(/* webpackChunkName: "secretSauce", webpackPreload: true */ 'vue-konami').then(async({default: KonamiCode}) => {
            return import(/* webpackChunkName: "vuex", webpackPreload: true */ 'vuex').then(async({default: Vuex}) => {
